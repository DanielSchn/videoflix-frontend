...
export class VideoplayerComponent {
  ...
  ngOnInit(): void {
    ...
    this.qualityOptions = [
      { label: '480p', src: this.constants.API_MEDIA_URL + this.videoSource.video_480p },
      { label: '720p', src: this.constants.API_MEDIA_URL + this.videoSource.video_720p },
      { label: '1080p', src: this.constants.API_MEDIA_URL + this.videoSource.video_1080p }
